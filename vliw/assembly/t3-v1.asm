;;TODO se for possível criar uma instrução que não seja o xor, usar uma para já colocar 12 no r0 
;; TODO ajustar para vliw
;; Informações 
    ;; Ordem dos vetores: R[] - A[] - B[]
...
;; Calcular ponteiro r1 
    ;; TODO por hora é 78, mas ajustar
    addi 1 
    add r3, r0 ;; r3 = 1 

    addi -5 ;; r0 = -4 = 1100 
    movh 6 ;; r0 = 0100 1100 = 78
...
;; Inicializar R 
    ...
    ;; r0 = 0 || r1 = 89 || r2 = 0 || r3 = 1 

;; Inicializar A 
    ;; TODO no loop se precisar no vliw, colocar contador como 13 e colocar o sub encima?
    addi -4 ;; r0 = -4 = 1100
    movh 0 ;; r0 = 0000 1100 = 12 -> contador 
...
;; Inicializar B 
    ...
    ;; r0 = 0 || r1 = 113 || r2 = 31 || r3 = 1 

;; Calcular valor de retorno para brzr #255 = 32 
    add r3, r2 ;; r3 = 32
    xor r2, r2 
    addi -4 ;; r0 = -4 = 1100
    movh 0 ;; r0 = 0000 1100 = 12 -> contador 
